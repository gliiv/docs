...
<ResponseField name="validationErrors" type="object">
  Present only on **400 Bad Request**. Maps field names (`phoneNumbers`, `message`, `senderId`) to specific error descriptions.
</ResponseField>
...
```json 400 Validation Error
{
    ...
    "validationErrors": {
        "phoneNumbers": "Phone numbers should be an array (max 20)",
