...
"og:title": "How to Send SMS Programmatically: High-Throughput API"
"og:description": "Learn how to use the POST endpoint to dispatch instant single or bulk SMS messages and handle high-priority programmatic text delivery via the API gateway"
keywords: ["send SMS API", "bulk text dispatch", "POST messages endpoint", "programmatic messaging"]
---
...
<ParamField body="senderId" type="string" required>
  The unique ID of your authorized **Sender**. Retrieve this from the [List All Senders](/list-senders) endpoint.
</ParamField>
