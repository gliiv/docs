...
seo:
  title: "Send SMS API: Dispatch High-Throughput Bulk Text"
  description: "POST /v1/api/messages/send. Programmatically dispatch instant single or bulk SMS up to 800 characters long."
---
