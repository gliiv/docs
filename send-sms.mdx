---
title: "Send SMS API: Dispatch High-Throughput Bulk Messages"
api: "POST https://api.gliiv.com/v1/api/messages/send"
description: "POST /v1/api/messages/send. Programmatically dispatch instant single or bulk SMS. Send text up to 800 characters to a maximum of 20 recipients."
---
