...
seo:
  title: "Gliiv API Authentication: Managing Secret API Keys"
  description: "Secure your programmatic bulk SMS requests. Learn how to securely generate, store, and authorize API headers using your unique x-api-key credential."
---
