...
<ResponseField name="api" type="API">
  ...
  <Expandable title="API">
    <ResponseField name="baseUrl" type="string">
      The base URL for all API endpoints. If `baseUrl` is an array, it will enable multiple base URL options that the user can toggle.
    </ResponseField>
    ...
    <ResponseField name="auth" type="Auth">
      <Expandable title="Auth">
        ...
        <ResponseField name="inputPrefix" type="string">
          ...
          E.g., an `inputPrefix` of `AuthKey` would set the default value of the authentication field to `AuthKey`.
        </ResponseField>
      </Expandable>
    </ResponseField>
...
<ResponseField name="footerSocials" type="FooterSocials">
  An object of social media accounts where the key/value pair represents the social media platform and the account URL.
