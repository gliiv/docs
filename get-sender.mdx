...
seo:
  title: "Get Sender Details API: Fetch SMS Identity Data"
  description: "GET /v1/api/senders/{senderId}. Fetch detailed info for a specific sender ID, ownership metadata, and balance."
---
