...
"og:title": "How to List Sender Identities: Retrieve Authorized IDs"
"og:description": "Learn how to use the GET endpoint to retrieve a paginated list of your authorized alphanumeric sender IDs and associated account credit balances for your app"
keywords: ["list sender IDs", "authorized senders", "GET senders endpoint", "fetch API identities"]
---
