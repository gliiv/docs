...
seo:
  title: "Gliiv Quickstart Guide: Send First SMS in 5 Minutes"
  description: "Create an account, register sender identities, and dispatch bulk SMS via dashboard or REST API in under five minutes."
---
