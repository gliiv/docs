...
seo:
  title: "Gliiv Quickstart Guide: Send Your First SMS in 5 Minutes"
  description: "Follow our quick setup guide to create an account, register an approved Sender identity, and dispatch bulk SMS via the dashboard or REST API instantly."
---
