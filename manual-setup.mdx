...
seo:
  title: "Create Bulk SMS Campaigns: Dynamic Scheduling Guide"
  description: "Learn to configure bulk SMS on Gliiv. Setup sender IDs, upload CSV sheets, map placeholders, and schedule campaigns."
---
