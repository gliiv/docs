...
seo:
  ...
  description: "Learn to configure bulk SMS on Gliiv. Setup sender IDs, calculate text credits, upload CSV sheets, map custom placeholders, and schedule future campaigns."
---
