...
"og:title": "How to Create and Schedule Bulk SMS Campaigns on Gliiv"
"og:description": "Learn how to configure bulk SMS campaigns, upload recipient CSV sheets, map dynamic placeholders, and schedule automated message deliveries successfully"
keywords: ["create SMS campaign", "bulk SMS scheduling", "CSV contact upload", "dynamic text placeholders"]
---
...
Select an identity from the **Sender** dropdown. This list contains the Senders that have been authorized for your account.

<Tip>
  Need an assigned Sender identity before you can dispatch a campaign? Follow our guide on how to <a href="/quickstart#2-obtain-an-approved-sender" target="_blank" rel="noopener noreferrer">Obtain an Approved Sender</a> to see all available request channels.
</Tip>
